...
SEASONINGS: Set[str] = {
    ...
    "盐", "海盐", "粗盐",
    # ===== 糖 =====
    "糖", "白糖", "冰糖", "红糖", "细砂糖", "糖粉", "黑糖",
    "德麦拉拉糖", "深色软红糖",
    # ===== 油 =====
    "油", "食用油", "橄榄油", "葵花籽油", "菜籽油", "花生油", "椰子油",
    "初榨橄榄油", "香油", "猪油", "黄油",
    "芥花籽油", "花生油", "松露油", "高温烹饪油", "菜籽油",
    # ===== 味精/鸡精 =====
    "味精", "鸡精",
    # ===== 酱油 =====
    "酱油", "生抽", "老抽", "蒸鱼豉油",
    # ===== 醋 =====
    "醋", "白醋", "香醋", "镇江香醋", "红酒醋",
    "苹果醋", "麦芽醋", "雪莉醋", "纯素白葡萄酒醋", "白葡萄酒醋",
    # ===== 料酒/酒 =====
    "料酒", "米酒", "绍兴料酒", "啤酒", "清酒",
    "葡萄酒", "白葡萄酒", "红葡萄酒",
    "白兰地", "黑朗姆酒", "干雪莉酒", "干白葡萄酒", "雪莉酒", "甜雪莉酒",
    # ===== 胡椒粉 =====
    "胡椒粉", "白胡椒粉", "黑胡椒粉",
    # ===== 花椒 =====
    "花椒", "花椒粉", "贡布胡椒",
    # ===== 八角/桂皮/香叶/丁香 =====
    "八角", "桂皮", "香叶", "丁香", "丁香粉", "多香果", "多香果粉",
    # ===== 葱姜蒜 =====
    "葱", "葱花", "姜", "蒜", "姜粉",
    "细香葱", "南姜", "蒜粒", "蒜粉", "姜蒜酱", "姜酱", "南姜酱", "蒜蓉酱",
    # ===== 辣椒 =====
    "辣椒", "干辣椒", "辣椒粉", "红辣椒", "剁椒", "泡椒", "青辣椒", "苏格兰帽椒",
    "辣椒油", "辣椒酱", "烟熏辣椒粉", "卡宴辣椒粉",
    "安乔干辣椒", "鸟眼辣椒", "辣椒碎", "干红辣椒", "红辣椒碎", "红辣椒粉", "红椒碎",
    # ===== 咖喱 =====
    "咖喱粉", "咖喱酱",
    "牙买加咖喱粉", "马德拉斯咖喱酱", "玛莎曼咖喱酱",
    "帕能咖喱酱", "泰式绿咖喱酱", "泰式红咖喱酱",
    # ===== 孜然 =====
    "孜然", "孜然粉", "孜然籽",
    # ===== 姜黄 =====
    "姜黄", "姜黄粉",
    # ===== 香草 =====
    "百里香", "迷迭香", "牛至", "罗勒", "欧芹", "薄荷", "肉豆蔻",
    "罗勒叶", "莳萝", "香菜", "韭菜", "蒜苗", "大葱",
    "欧芹碎", "鲜欧芹碎", "香菜叶", "香菜籽", "香菜粉",
    "干莳萝", "干薄荷", "干牛至", "葫芦巴",
    "鲜罗勒", "鲜百里香", "辣薄荷", "马郁兰", "鼠尾草", "漆树粉", "龙蒿叶", "肉豆蔻粉",
    # ===== 肉桂 =====
    "肉桂", "肉桂粉", "肉桂棒",
    # ===== 淀粉/面粉 =====
    "淀粉", "水淀粉", "玉米淀粉", "面包糠", "淀粉水",
    "中筋面粉", "面粉", "自发粉", "黄豆粉", "糯米粉",
    "荞麦粉", "粗粒小麦粉", "高筋白面粉", "高筋全麦粉", "天妇罗粉", "白面粉",
    # ===== 鱼露/蚝油 =====
    "鱼露", "蚝油", "辣酱油",
    # ===== 酱料 =====
    "干黄酱", "甜面酱", "郫县豆瓣酱", "芥末酱", "花生酱",
    "烧烤酱", "焦糖酱", "焦糖糖浆", "辣椒酱", "奇米丘里酱", "芝麻酱",
    "恩奇拉达酱", "海鲜酱", "辣酱", "墨西哥鲜酱", "苏梅酱", "红椒酱", "甜辣酱",
    "塔巴斯科辣酱", "白芝麻酱", "罗望子酱", "香草豆酱",
    "第戎芥末酱", "英式芥末酱", "芥末粉", "芥末籽",
    # ===== 汁 =====
    "柠檬汁", "青柠汁",
    # ===== 高汤/汤底 =====
    ...
    "水",
    "可可粉", "五香粉", "芝麻", "枫糖浆",
    "多用途调料", "葛缕子籽", "水瓜柳", "清蜂蜜", "椰子糖",
    "吉士粉", "法吉塔调料", "茴香籽",
    "葛拉姆马萨拉", "吉利丁片", "金黄细砂糖", "黄金糖浆",
    "白砂糖", "哈里萨辣酱", "意大利综合香料",
    "卡布萨香料", "浅色软红糖", "混合香料", "糖蜜",
    "罂粟籽", "罂粟籽粉", "椰糖",
    "粉色食用色素", "德式酸菜", "调味料", "荷兰香料粉",
    "糖浆", "甜烟熏辣椒粉", "泰式辣椒酱",
    "无味吉利丁", "油醋汁", "黄色食用色素",
}
...
def is_seasoning(name: str) -> bool:
    """Return True if the ingredient name is classified as a seasoning."""
...
def load_substitutions(
    ...
    """Load the substitution rules from a JSON file."""
    if not os.path.exists(filepath):
        return {}
    with open(filepath, "r", encoding="utf-8") as f:
        return json.load(f)
